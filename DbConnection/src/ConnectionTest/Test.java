...
public class Test {
   ...
   Connection conn = DbConnection.getOracleConnection();
    ...
    public static void main(String[] args) {
        Test t = new Test();
        //Only for creating table
       t.createTable();
       
       //call for insert
        t.insertIntoBest(2, "Forruq", "Bangladesh");
        t.insertIntoBest(3, "Jahid", "Bangladesh");
        t.insertIntoBest(4, "Siddik", "Bangladesh");
        t.insertIntoBest(5, "Hasib", "Bangladesh");
        
        //call for update
        t.updateIntoBest(2, "Milton" , "Bangladesh");
